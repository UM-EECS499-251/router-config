# Configure the MPLS VPN Network using Cisco 7200

Build MPLS VPN using Cisco 7200 on GNS3.  

## References:

1. [Config MPLS VPN Network](https://www.cisco.com/c/en/us/support/docs/multiprotocol-label-switching-mpls/mpls/13733-mpls-vpn-basic.html)
